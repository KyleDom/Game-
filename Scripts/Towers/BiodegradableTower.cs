...
public class BiodegradableTower : Tower
{
    ...
    protected override void Attack()
    {
        ...
        GameObject bullet = Instantiate(projectilePrefab, projectileSpawnPos.position, Quaternion.identity); //create bullet 
        if(currentEnemy.CompareTag("Biodegradable")){ //checks if ang enemy is of type biodegradable;
